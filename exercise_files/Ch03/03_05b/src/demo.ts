...
x.number = 1234; // gives error, not a string. but with union, is possible
x.id = "01234" // Defining new properties to variable x.
x.yeerrr = "YEEEEEEEEEER"
x.active = true
x.log = () => console.log()

//x = 1 // this gives an error, duh
